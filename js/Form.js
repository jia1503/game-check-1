...
//players = [c1, c2, c3, c4];
   ...
   choose1.mousePressed(()=>{
    if(playerCount===4 && animations!=0){
      ...
      choose3.hide();
      choose4.hide();
      //i have made a different database for this code, i have the previous cod saved incase this goes wrong.
      //have also made changes in game.js
      //how to make each player get the animation they want? do we have to make changes in the database?
      //after the players get desired animation we can start makng the game.
